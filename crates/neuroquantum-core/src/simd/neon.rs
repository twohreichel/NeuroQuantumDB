...
use std::arch::aarch64::{vld1q_u8, vst1q_u8, uint8x16_t, vdupq_n_u8, vshrq_n_u8, vandq_u8, vorrq_u8, vshlq_n_u8, vdupq_n_f32, vld1q_f32, vfmaq_f32, vgetq_lane_f32, vmulq_f32, vaddq_f32, vst1q_f32, vceqq_u8};
