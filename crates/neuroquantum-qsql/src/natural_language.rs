...
pub struct SemanticAnalyzer {
    ...
    pub embeddings: HashMap<String, WordEmbedding>,
    /// Synonym groups for query expansion
    pub synonyms: HashMap<String, Vec<String>>,
    /// Domain-specific term mappings
    pub domain_terms: HashMap<String, DomainTerm>,
    /// N-gram context patterns
    pub ngram_patterns: HashMap<String, ContextPattern>,
}
...
pub struct DependencyParser {
    ...
    pub verb_patterns: HashSet<String>,
    /// Prepositions
